...
- Adult onboarding, registration, login and logout.
- Session restoration.
- Family dashboard.
- Child and teen profile creation.
- Adult, child and teen shell separation.
- Routine list.
- Routine creation.
- Routine editing.
- Routine duplication.
- Routine pause/activate/delete.
- Adjust routine only for today through routine overrides.
- Guided child routine execution.
- Help, pause and more-time actions in child flow.
