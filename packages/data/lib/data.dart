export 'src/file_local_store_stub.dart'
    if (dart.library.io) 'src/file_local_store_io.dart';
export 'src/drift_local_store_stub.dart'
    if (dart.library.io) 'src/drift_local_store_io.dart';
