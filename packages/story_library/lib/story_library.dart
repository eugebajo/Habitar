...
List<Story> demoStories() {
  return demoStoryContent()
      .map((content) => content.story)
  ...
  return [
    DemoStoryContent(
      story: Story(
        ...
        value: 'pedir ayuda',
        body:
            'Una niña miraba su mochila abierta. Había una botella, un cuaderno y una campera. Todo parecía mucho junto. Respiró una vez y dijo: necesito una pista. Su mamá señaló la botella. La guardó. Después eligió el cuaderno. Cuando terminó, la mochila ya no parecía una montaña. Era solo una mochila esperando paso a paso.',
      ),
      durationMinutes: 3,
      mainEmotion: 'agobio',
      questions: [
        '¿Qué hizo cuando todo parecía mucho?',
        '¿Qué pista te gustaría pedir hoy?',
      ],
    ...
    DemoStoryContent(
      story: Story(
        ...
        body:
            'El martes tenía una forma conocida: clase, merienda, tarea y dibujo. Pero llovió y la clase de deporte cambió. Ana sintió calor en la cara. Su abuelo dibujó dos columnas: lo que cambió y lo que sigue igual. La merienda seguía. La tarea seguía. El dibujo seguía. El martes no desapareció; solo había cambiado una pieza.',
      ),
      durationMinutes: 4,
      mainEmotion: 'sorpresa',
      questions: [
        '¿Qué parte del plan siguió igual?',
        '¿Qué ayuda cuando una pieza cambia?',
      ],
    ...
    DemoStoryContent(
      ...
      questions: [
        '¿Qué hizo Leo antes de volver a hablar?',
        '¿Qué gesto pequeño puede reparar algo?',
      ],
